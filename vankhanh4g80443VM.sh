...
makeConfig() {
	...
	echo "---------------"
	read -p "Link website: https://vankhanh4g.com/"
	echo "---------------"
	read -p "API key của web: admin@vankhanh4g1996"
	echo "---------------"
...
Nodes:
  -
    PanelType: "V2board" 
    ApiConfig:
      ApiHost: "https://vankhanh4g.com"
      ApiKey: "admin@vankhanh4g1996"
      NodeID: $NodeID80
      NodeType: V2ray 
      Timeout: 30 
      EnableVless: false 
    ...
    ControllerConfig:
      ...
      CertConfig:
        ...
        CertFile: /etc/XrayR/cert-cloudfly/vankhanh4g.crt 
        KeyFile: /etc/XrayR/cert-cloudfly/vankhanh4g.key
        Provider: alidns 
        Email: test@me.com
        DNSEnv: 
